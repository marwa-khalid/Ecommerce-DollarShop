              ...
              <>
                <div className="user-dropdown" >
                  <NavLink to="/cart" className="btn mx-2" >
                    ...
                    <img className='rounded-circle' src={`https://dollar-wala-server.vercel.app/${user.image}`}  style={{ width: '40px', height: '40px' }}  alt="" onClick={toggleDropdown}/>
                    {showDropdown && (
                      <div className="dropdown-menu dropdown-menu-end show">
                        <div className="d-flex flex-column align-items-center">
                          <img
                            className='rounded-circle mb-2'
                            src={`https://dollar-wala-server.vercel.app/${user.image}`}
