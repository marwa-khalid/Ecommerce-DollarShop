...
const ProductDetail = () => {
  ...
  useEffect(() => {
    const getProduct = async () => {
      setLoading(true);
      const response = await fetch(`https://dollar-wala-server.vercel.app/api/products/${id}`);
    ...
    const getReviews = async () => {
      ...
      const response = await fetch(`https://dollar-wala-server.vercel.app/api/reviews/${id}`);
